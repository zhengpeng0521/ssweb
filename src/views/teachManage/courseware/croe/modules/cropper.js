...
export default class Cropper extends Base {
  ...
  start() {
    ...
    const radio = canvasCssWidth / canvasWidth
    const marginLeft = (canvasCssWidth * 0.1) / radio
    const marginTop = (canvasCssHeight * 0.1) / radio
    const width = (canvasCssWidth * 0.8) / radio
    const height = (canvasCssHeight * 0.8) / radio
