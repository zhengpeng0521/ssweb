...
export default {
  ...
  data() {
    return {
      action: `/api/saas/${window.SS_CRM}/crm/stuInfo/clue/leads/upload/uploadExcel`,
      fileName: '',
      fileList: []
    }
  },
  ...
  methods: {
    ...
    download() {
      ...
      exportFile(`${window.SS_CRM}/crm/stuInfo/clue/excel/downloadStuInfoModel`, { type })
    }
  }
}
</script>
