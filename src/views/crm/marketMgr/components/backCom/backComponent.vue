<template>
  <div class="back_container">
    ...
    <div class="search">
      ...
      <div>
        <el-button
          v-log="{compName:'进销存管理',eventName:'web-【学员CRM】-进销存管理-库存管理-新增退领'}"
    ...
    >
      ...
      >
        <div class="add_form_box">
          <el-form-item label="退领日期" prop="date">
            <el-date-picker
          ...
          <el-form-item label="领用人" prop="user">
            <el-input v-model="addNewData.user" clearable placeholder="请输入领用人" />
          </el-form-item>
        </div>
        <div class="dialog_table_box">
          <el-table :data="addDataTble" style="width: 100%" border stripe>
            ...
            <el-table-column width="50">
              <template slot-scope="scope">
                <el-button
                  v-log="{compName:'进销存管理',eventName:'web-【学员CRM】-进销存管理-库存管理-删除退领'}"
...
<script src='./backComponent.js'></script>
