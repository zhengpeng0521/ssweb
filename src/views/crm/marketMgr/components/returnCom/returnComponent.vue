<template>
  <div class="return_container">
    ...
    <div class="search">
      ...
      <div>
        <el-button
          v-log="{compName:'进销存管理',eventName:'web-【学员CRM】-进销存管理-库存管理-新增退货'}"
    ...
    <div class="table_checked_box">
      ...
      <span>
        <el-popover v-model="visible2" placement="top" width="160">
          ...
          <el-button
            v-log="{compName:'进销存管理',eventName:'web-【学员CRM】-进销存管理-库存管理-删除退货'}"
    ...
    <CommonTable
      ...
      :options="options"
      table-key="crm_inventory_return"
      ...
      >
        <div class="add_form_box">
          ...
          <el-form-item label="供应商" prop="provider">
            <el-input v-model="addNewData.provider" clearable placeholder="请输入供应商" />
          </el-form-item>
        </div>
...
<script src='./returnComponent.js'></script>

<style lang="scss" scoped>
.return_container /deep/ {
  .el-table td,
  .el-table th.is-leaf {
    border-bottom: none;
  }
