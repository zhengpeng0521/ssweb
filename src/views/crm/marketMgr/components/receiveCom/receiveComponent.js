...
export default {
  ...
  data() {
    return {
      ...
      dialogTitle: '新增',
      rules: {
        date: [{ required: true, message: '请输入领用日期', trigger: 'change' }]
      },
      addNewData: {
        date: '',
        user: '',
  ...
  methods: {
    ...
    deleteStockAction() {
      ...
      this.deleteStock({
        ids,
        callback: this.searchHandle.bind(this, { type: '3', pageIndex: this.$refs.tableCommon.pageIndex })
      })
