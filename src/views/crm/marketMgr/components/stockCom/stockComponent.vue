<template>
  <div class="stock_container">
    ...
    <div class="search">
      ...
      <div>
        <el-button
          v-log="{compName:'进销存管理',eventName:'web-【学员CRM】-进销存管理-库存管理-新增进货'}"
        ...
        >
          ...
          <div class="br">
            ...
            <el-button
              ...
              size="mini"
              class="edit_btn"
              @click="deleteStockAction"
            >确定</el-button>
          </div>
          <el-button
            v-log="{compName:'进销存管理',eventName:'web-【学员CRM】-进销存管理-库存管理-删除进货'}"
    ...
    >
      ...
      >
        <el-button
          :loading="loading"
          class="cancel_btn"
          @click="cancelDialog('addNewForm')"
        >取 消</el-button>
        <el-button
          :loading="loading"
          type="primary"
          @click="submitForm('addNewForm')"
        >保 存</el-button>
      </span>
    </el-dialog>
  </div>
...
<script src="./stockComponent.js"></script>

<style lang="scss" scoped>
.stock_container /deep/ {
  .el-table td,
  .el-table th.is-leaf {
    border-bottom: none;
  }
