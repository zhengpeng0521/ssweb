...
export default class Main extends Base {
  ...
  toDataURL(type, quality = 1) {
    ...
    const lowerCanvasElStyle = Object.assign(
      {},
      this.canvas.lowerCanvasEl.style
    )
    const upperCanvasElStyle = Object.assign(
      {},
      this.canvas.upperCanvasEl.style
    )
  ...
  getViewPortImage() {
    ...
    const url = this.getCanvas().toDataURL(cropInfo)
    util.setStyle(this.canvas.wrapperEl, wrapperElStyle)
    util.setStyle(this.canvas.lowerCanvasEl, lowerCanvasElStyle)
    util.setStyle(this.canvas.upperCanvasEl, upperCanvasElStyle)
    return {
